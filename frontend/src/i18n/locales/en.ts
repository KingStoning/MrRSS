...
const en: TranslationMessages = {
  ...
  setting: {
    ...
    typography: {
      ...
      customFont: 'Enter a font family',
      loadFonts: 'Load local fonts',
      fontAccessFailed: 'Unable to list all fonts; choose a detected font or enter its name',
      ...
      articleTitleFontSize: 'Article Title Size',
      articleTitleFontSizeDesc: 'Set the article title size independently from the body text',
      ...
      fontHyperlegible: 'Accessible',
      fontSerif: 'Serif',
      fontSerifDefault: 'Default Serif',
      fontSystem: 'System Font',
      fontSystemDefault: 'System Default',
      readerMaxWidth: 'Maximum content width',
      readerMaxWidthDesc: 'Keep long-form text centered at a comfortable measure',
    },
    customization: {
    ...
    reading: {
      ...
      showReadingTimeDesc: 'Display an estimated duration in article metadata',
