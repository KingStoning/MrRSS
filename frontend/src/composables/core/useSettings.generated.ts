...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    ai_chat_save_history: settingsDefaults.ai_chat_save_history,
    ...
    article_table_columns: settingsDefaults.article_table_columns,
    article_title_font_size: settingsDefaults.article_title_font_size,
    article_toolbar_layout: settingsDefaults.article_toolbar_layout,
    auto_cleanup_enabled: settingsDefaults.auto_cleanup_enabled,
    auto_mark_read_days: settingsDefaults.auto_mark_read_days,
    auto_mark_read_enabled: settingsDefaults.auto_mark_read_enabled,
    ...
    data_directory: settingsDefaults.data_directory,
    date_format: settingsDefaults.date_format,
    ...
    miniflux_api_password: settingsDefaults.miniflux_api_password,
    miniflux_auto_sync_interval: settingsDefaults.miniflux_auto_sync_interval,
    miniflux_enabled: settingsDefaults.miniflux_enabled,
    miniflux_last_sync_time: settingsDefaults.miniflux_last_sync_time,
    miniflux_server_url: settingsDefaults.miniflux_server_url,
    miniflux_sync_on_startup: settingsDefaults.miniflux_sync_on_startup,
    miniflux_username: settingsDefaults.miniflux_username,
    ...
    relative_time: settingsDefaults.relative_time,
    ...
    scroll_mark_as_read: settingsDefaults.scroll_mark_as_read,
    ...
    show_unread_counts: settingsDefaults.show_unread_counts,
    ...
    siyuan_api_token: settingsDefaults.siyuan_api_token,
    siyuan_enabled: settingsDefaults.siyuan_enabled,
    siyuan_endpoint: settingsDefaults.siyuan_endpoint,
    siyuan_folder: settingsDefaults.siyuan_folder,
    siyuan_notebook_id: settingsDefaults.siyuan_notebook_id,
    startup_minimized: settingsDefaults.startup_minimized,
    ...
    time_format: settingsDefaults.time_format,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    ai_chat_save_history: data.ai_chat_save_history === 'true',
    ...
    article_table_columns: data.article_table_columns || settingsDefaults.article_table_columns,
    article_title_font_size: parseInt(data.article_title_font_size) || settingsDefaults.article_title_font_size,
    article_toolbar_layout: data.article_toolbar_layout || settingsDefaults.article_toolbar_layout,
    auto_cleanup_enabled: data.auto_cleanup_enabled === 'true',
    auto_mark_read_days: parseInt(data.auto_mark_read_days) || settingsDefaults.auto_mark_read_days,
    auto_mark_read_enabled: data.auto_mark_read_enabled === 'true',
    ...
    data_directory: data.data_directory || settingsDefaults.data_directory,
    date_format: data.date_format || settingsDefaults.date_format,
    ...
    miniflux_api_password: data.miniflux_api_password || settingsDefaults.miniflux_api_password,
    miniflux_auto_sync_interval: parseInt(data.miniflux_auto_sync_interval) || settingsDefaults.miniflux_auto_sync_interval,
    miniflux_enabled: data.miniflux_enabled === 'true',
    miniflux_last_sync_time: data.miniflux_last_sync_time || settingsDefaults.miniflux_last_sync_time,
    miniflux_server_url: data.miniflux_server_url || settingsDefaults.miniflux_server_url,
    miniflux_sync_on_startup: data.miniflux_sync_on_startup === 'true',
    miniflux_username: data.miniflux_username || settingsDefaults.miniflux_username,
    ...
    relative_time: data.relative_time === 'true',
    ...
    scroll_mark_as_read: data.scroll_mark_as_read === 'true',
    ...
    show_unread_counts: data.show_unread_counts === 'true',
    ...
    siyuan_api_token: data.siyuan_api_token || settingsDefaults.siyuan_api_token,
    siyuan_enabled: data.siyuan_enabled === 'true',
    siyuan_endpoint: data.siyuan_endpoint || settingsDefaults.siyuan_endpoint,
    siyuan_folder: data.siyuan_folder || settingsDefaults.siyuan_folder,
    siyuan_notebook_id: data.siyuan_notebook_id || settingsDefaults.siyuan_notebook_id,
    startup_minimized: data.startup_minimized === 'true',
    ...
    time_format: data.time_format || settingsDefaults.time_format,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_chat_save_history: (settingsRef.value.ai_chat_save_history ?? settingsDefaults.ai_chat_save_history).toString(),
    ...
    article_table_columns: settingsRef.value.article_table_columns ?? settingsDefaults.article_table_columns,
    article_title_font_size: (settingsRef.value.article_title_font_size ?? settingsDefaults.article_title_font_size).toString(),
    article_toolbar_layout: settingsRef.value.article_toolbar_layout ?? settingsDefaults.article_toolbar_layout,
    auto_cleanup_enabled: (settingsRef.value.auto_cleanup_enabled ?? settingsDefaults.auto_cleanup_enabled).toString(),
    auto_mark_read_days: (settingsRef.value.auto_mark_read_days ?? settingsDefaults.auto_mark_read_days).toString(),
    auto_mark_read_enabled: (settingsRef.value.auto_mark_read_enabled ?? settingsDefaults.auto_mark_read_enabled).toString(),
    ...
    data_directory: settingsRef.value.data_directory ?? settingsDefaults.data_directory,
    date_format: settingsRef.value.date_format ?? settingsDefaults.date_format,
    ...
    miniflux_api_password: settingsRef.value.miniflux_api_password ?? settingsDefaults.miniflux_api_password,
    miniflux_auto_sync_interval: (settingsRef.value.miniflux_auto_sync_interval ?? settingsDefaults.miniflux_auto_sync_interval).toString(),
    miniflux_enabled: (settingsRef.value.miniflux_enabled ?? settingsDefaults.miniflux_enabled).toString(),
    miniflux_last_sync_time: settingsRef.value.miniflux_last_sync_time ?? settingsDefaults.miniflux_last_sync_time,
    miniflux_server_url: settingsRef.value.miniflux_server_url ?? settingsDefaults.miniflux_server_url,
    miniflux_sync_on_startup: (settingsRef.value.miniflux_sync_on_startup ?? settingsDefaults.miniflux_sync_on_startup).toString(),
    miniflux_username: settingsRef.value.miniflux_username ?? settingsDefaults.miniflux_username,
    ...
    reader_max_width: (settingsRef.value.reader_max_width ?? settingsDefaults.reader_max_width).toString(),
    refresh_mode: settingsRef.value.refresh_mode ?? settingsDefaults.refresh_mode,
    relative_time: (settingsRef.value.relative_time ?? settingsDefaults.relative_time).toString(),
    ...
    scroll_mark_as_read: (settingsRef.value.scroll_mark_as_read ?? settingsDefaults.scroll_mark_as_read).toString(),
    ...
    show_reading_time: (settingsRef.value.show_reading_time ?? settingsDefaults.show_reading_time).toString(),
    show_unread_counts: (settingsRef.value.show_unread_counts ?? settingsDefaults.show_unread_counts).toString(),
    ...
    siyuan_api_token: settingsRef.value.siyuan_api_token ?? settingsDefaults.siyuan_api_token,
    siyuan_enabled: (settingsRef.value.siyuan_enabled ?? settingsDefaults.siyuan_enabled).toString(),
    siyuan_endpoint: settingsRef.value.siyuan_endpoint ?? settingsDefaults.siyuan_endpoint,
    siyuan_folder: settingsRef.value.siyuan_folder ?? settingsDefaults.siyuan_folder,
    siyuan_notebook_id: settingsRef.value.siyuan_notebook_id ?? settingsDefaults.siyuan_notebook_id,
    startup_minimized: (settingsRef.value.startup_minimized ?? settingsDefaults.startup_minimized).toString(),
    ...
    time_format: settingsRef.value.time_format ?? settingsDefaults.time_format,
